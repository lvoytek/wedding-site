...
import { guestData, primaryData, contactData, rsvpData } from '@libs/person';
...
export class RsvpFormComponent {
	@Output() submit = new EventEmitter<RecursivePartial<primaryData & contactData & rsvpData>>()
	...
	onSubmit() {
		...
		let rsvpData: RecursivePartial<primaryData & contactData & rsvpData>;
